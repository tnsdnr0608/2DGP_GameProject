from pico2d import load_image, SDL_KEYDOWN, SDL_KEYUP, SDLK_RIGHT, SDLK_LEFT, SDLK_UP, SDLK_BACKSPACE, SDLK_DOWN, \
...
class Slide:
    ...
    def do(pikachu2):
        ...
        pikachu2.y += pikachu2.is_jump

        if pikachu2.y >= pikachu2.slide_distance:
            pikachu2.is_jump = -1
